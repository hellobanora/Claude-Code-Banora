...
export const services: Service[] = [
  {
    ...
    metaDescription: 'Professional chiropractic adjustments in Tweed Heads South. Dr James Shipway and Dr Paul Cater use Gonstead, SOT, Diversified, Thompson Drop and Activator techniques. Book online today.',
    ...
    overview: 'At Banora Chiropractic, our adjustments are never one-size-fits-all. Dr James and Dr Paul each bring different techniques to the table — from precise Gonstead adjustments to gentle Activator methods — so your care is matched to what your body needs. Whether you are dealing with stiffness, pain, or just want to move better, we will work with you to find the right approach.',
    benefits: [
